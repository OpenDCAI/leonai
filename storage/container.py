...
# @@@repo-registry - maps repo name → (supabase module path, class name)
...
class StorageContainer:
    ...
    _REPO_NAMES = tuple(_REPO_REGISTRY.keys())
    ...
    def _resolve_repo_providers(
        ...
        *,
        ...
        overrides: Mapping[str, Any] = repo_providers or {}
    ...
    # SQLite factories (called only when provider == "sqlite")

    def _sqlite_checkpoint_repo(self) -> CheckpointRepo:
    ...
    def _sqlite_thread_config_repo(self) -> ThreadConfigRepo:
    ...
    def _sqlite_eval_repo(self) -> EvalRepo:
